...
Strings.OfficeOM.L_CustomFunctionDefinitionMissing = "Властивість із таким іменем, яка представляє визначення функції, має існувати в Excel.CustomFunctions.";
Strings.OfficeOM.L_CustomFunctionImplementationMissing = 'Властивість із таким іменем в Excel.CustomFunctions, яка представляє визначення функції, має містити властивість "call", що впроваджує функцію.';
