...
export const exampleSamples = {
  ...
  PivotTable: [
    {
      ...
      rawUrl:
        'https://raw.githubusercontent.com/<ACCOUNT>/<REPO>/<BRANCH>/samples/excel/55-pivottable/refresh-pivot-table.yaml',
      group: 'PivotTable',
      api_set: {
        ExcelApi: 1.3,
      },
  ...
  'Preview APIs': [
    ...
    },
    {
      ...
      rawUrl:
        'https://raw.githubusercontent.com/<ACCOUNT>/<REPO>/<BRANCH>/samples/excel/89-preview-apis/chart-formatting.yaml',
      group: 'Preview APIs',
      api_set: {
        ExcelAPI: 1.8,
      },
    ...
    },
    {
      ...
      rawUrl:
        'https://raw.githubusercontent.com/<ACCOUNT>/<REPO>/<BRANCH>/samples/excel/89-preview-apis/events-disable-events.yaml',
      group: 'Preview APIs',
      api_set: {
        ExcelAPI: 1.8,
      },
    ...
    },
    {
      ...
      name: 'PivotTable Calculations',
      fileName: 'pivottable-calculations.yaml',
      description: 'Change the calculations the PivotTable performs.',
      rawUrl:
        'https://raw.githubusercontent.com/<ACCOUNT>/<REPO>/<BRANCH>/samples/excel/89-preview-apis/pivottable-calculations.yaml',
      group: 'Preview APIs',
      api_set: {
        ExcelApi: 1.8,
      },
    ...
    },
    {
      ...
      rawUrl:
        'https://raw.githubusercontent.com/<ACCOUNT>/<REPO>/<BRANCH>/samples/excel/89-preview-apis/pivottable-create-and-modify.yaml',
      group: 'Preview APIs',
      api_set: {
        ExcelApi: 1.8,
      },
    ...
    },
    {
      ...
      name: 'PivotTable filters and summaries',
      fileName: 'pivottable-filters-and-summaries.yaml',
      description: 'Filter PivotTable data and show different summarizations.',
      rawUrl:
        'https://raw.githubusercontent.com/<ACCOUNT>/<REPO>/<BRANCH>/samples/excel/89-preview-apis/pivottable-filters-and-summaries.yaml',
      group: 'Preview APIs',
      api_set: {
        ExcelApi: 1.8,
      },
    ...
    },
    {
      ...
      description:
        'Work with RangeAreas, which are sets of ranges that need not be contiguous.',
      rawUrl:
    ...
    },
    {
      ...
      rawUrl:
        'https://raw.githubusercontent.com/<ACCOUNT>/<REPO>/<BRANCH>/samples/excel/89-preview-apis/range-copyfrom.yaml',
      group: 'Preview APIs',
      api_set: {
        ExcelAPI: 1.8,
      },
...
export const BasicSamples = () => (
  <Samples samplesByGroup={exampleSamples} openSample={voidFunc} />
)
