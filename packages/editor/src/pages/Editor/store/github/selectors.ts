...
export const getIsLoggingInOrOut = (state: IState): boolean => state.github.isLoggingInOrOut;

export const getIsAuthDialogOpen = (state: IState): boolean => state.github.isAuthDialogVisible;
