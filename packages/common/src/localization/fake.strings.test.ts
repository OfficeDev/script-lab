...
describe("localization fake strings", () => {
  ...
  it("with symbols", () => expect(getFakeString("... Hello World!")).toEqual("... Olleh Dlrow!"));
  it("really mixed", () => expect(getFakeString("hi thERe wORLd")).toEqual("ih erEHt dLROw"));
});

describe("localization fake strings long", () => {
  it("basic string", () => expect(getFakeStringLong("Hello World")).toEqual("Ooolleeeh Dlrooow"));
  it("all lowercase", () => expect(getFakeStringLong("hello world")).toEqual("ooolleeeh dlrooow"));
  it("all uppercase", () => expect(getFakeStringLong("HELLO WORLD")).toEqual("OOOLLEEEH DLROOOW"));
  it("mixed", () => expect(getFakeStringLong("Hi there world")).toEqual("Ih eeereeeht dlrooow"));
  it("with symbols", () =>
